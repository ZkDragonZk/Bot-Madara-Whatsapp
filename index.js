...
*/
const XPTN = 'BOT Madara'; // JANGAN DI UBAH NNTI EROR
const instagram = ''; // JANGAN DI UBAH NNTI EROR
const nomer = ''; // JANGAN DI UBAH NANTI EROR
const aktif = ''; // DI GANTI AUTO EROR
const groupwa = ''; // DI GANTI AUTO EROR
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] Madara está ficando online!`);
});
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @zk`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @zk`)
})
...
conn.sendMessage(group.gid, "hello everyone me chamo Madara!", MessageType.extendedText) // say hello to everyone on the group
...
conn.sendMessage(id, '3aalaikumsalam, [!] Para ver meu comandos Digite #help/#info/#owner' ,MessageType.text);
}
else if (text == 'salam'){
conn.sendMessage(id, 'Waalaikumsalam, [!] Para ver meu comandos Digite #help/#info/#owner' ,MessageType.text);
}
...
conn.sendMessage(id, 'Olá! Para ver meu Comandos Digite #help 😛  ',MessageType.text);
}
else if (text == 'P'){
conn.sendMessage(id, 'Olá! Para ver meu Comandos Digite #help 😛 ' ,MessageType.text);
}
...
conn.sendMessage(id, '[💃] Meu Dono Está no Discord!' ,MessageType.text);
}
else if (text == 'bot'){
conn.sendMessage(id, 'Opa! sou o Criador do Bot! 🚀 no que Posso ajudar?' ,MessageType.text);
}
else if (text == 'hai'){
conn.sendMessage(id, 'Sim?' ,MessageType.text);
}
else if (text == 'bangsat'){
conn.sendMessage(id, 'tóxico detectado' ,MessageType.text);
}
else if (text == 'Ngentod'){
conn.sendMessage(id, 'Quero comprar?' ,MessageType.text);
}
else if (text == 'Anjing'){
...
conn.sendMessage(id, 'Testando 1,2,3 .help' ,MessageType.text);
}
else if (text == 'Hai'){
conn.sendMessage(id, 'Olá! Para ver meu Comandos Digite #help 😛' ,MessageType.text);
}
else if (text == '.ttp'){
conn.sendMessage(id, ' *DAQUI UM DIAS VAMOS LIBERA O BOT OFICIAL* ' ,MessageType.text);
}
else if (text == 'Woi'){
conn.sendMessage(id, 'Olá! Para ver meu Comandos Digite #help 😛' ,MessageType.text);
}
...
conn.sendMessage(id, 'DISCORD: zk#8075' ,MessageType.text);
}
else if (text == '.coowner'){
conn.sendMessage(id, 'DISCORD: zk#8075' ,MessageType.text);
}
else if (text == '.groupbot'){
conn.sendMessage(id, 'SEM GRUPO NO MOMENTO' ,MessageType.text);
}
else if (text == '.tools1'){
conn.sendMessage(id, ' *[🔧]Ferramentas em destaque 1!!!* ' ,MessageType.text);
}
else if (text == '.tools2'){
conn.sendMessage(id, ' *[🔧]Ferramentas em destaque 2!!!* ' ,MessageType.text);
}
else if (text == '.tools3'){
conn.sendMessage(id, ' *[🔧]Ferramentas em destaque 3!!!* ' ,MessageType.text);
}
else if (text == '.tools4'){
conn.sendMessage(id, ' *[🔧]Ferramentas em destaque 4!!!* ' ,MessageType.text);
}
else if (text == '.tools5'){
conn.sendMessage(id, ' *[🔧]Ferramentas em destaque 5!!!* ' ,MessageType.text);
}
else if (text == 'Euy'){
conn.sendMessage(id, '[!] Para ver meu comandos Digite #help/#info/#owner' ,MessageType.text);
}
else if (text == 'makasi'){
...
axios.get(`https://st4rz.herokuapp.com/api/ytv?url=${teks}`).then((res) => {
    let hasil = `Video está disponível no link abaixo, por favor clique no link e baixe os resultado\n\n\nTitulo: ${res.data.title}\n\nTamanho do video: ${res.data.filesize}\n\nLink: ${res.data.result}`;
    conn.sendMessage(id, hasil ,MessageType.text);
})
}
...
axios.get('https://api.banghasan.com/quran/format/json/acak').then((res) => {
    ...
    let hasil = `[${ket}]   ${res.data.acak.ar.teks}\n\n${res.data.acak.id.teks}(QS.${res.data.surat.nama}, Parágrafo ${ket})`;
    conn.sendMessage(id, hasil ,MessageType.text);
})
}
if (text.includes(".bitly")){
...
axios.get(`http://scrap.terhambar.com/tiktokfull?link=${tictoc}`).then((res) => {
	 conn.sendMessage(id, '[WAIT] Searching...❗', MessageType.text)
     let titoe = `“Sucesso $$$ Clique no link abaixo para baixar o resultado. $ \nClique no link abaixo-\n\nTitulo: ${res.data.deskripsi} \n\nDuraçao: ${res.data.durasi}\n\nNama: ${res.data.nama}\n\nUrl: ${res.data.urlvideo}`;
...
conn.sendMessage(id, 'enviar .fotografia de menina / menino \ n \ nExemplo: foto de menina' ,MessageType.text);
}
else if (text == '.help'){
conn.sendMessage(id, ' _OBRIGADO POR USAR ESTE RECURSO ... PARA FAZER ESTE BOT VERIFIQUE O CANAL *Name TFM* ' ,MessageType.text);
}
else if (text == '.tools1'){
conn.sendMessage (id, '_🗣️Obrigado por usar BOT * BOT XATURNUSSLEEPY *, Siga Instagram Mimin Yah😻: https://www.instagram.com/juliocezrs/', MessageType.text);
}
else if (text == '.menu'){
conn.sendMessage (id, '_🗣️Obrigado por usar BOT * BOT XATURNUSSLEEPY *, Siga Instagram Mimin Yah😻: https://www.instagram.com/juliocezrs/', MessageType.text);
}
...
const get = require('got')
    ...
    var positvo = (body[0]['positvo']);
    var ficou bem  = (body[0]['ficou bem']);
    var mortes = (body[0]['mortes']);
    var tratado = (body[0]['tratado']);
    console.log(body[0]['name'])
    conn.sendMessage(id,`🔎ÚLTIMA PRAGA COVID-19 NA INDONÉSIA🔍 \ n \ n📈Positive ==> $ {positive} \ n📉Cured ==> $ {recover} \ n📋Morte ==> $ {morreu} \ n🗒️Tratado = => $ {tratado} `, MessageType.text);
}
